...
from blog.forms.CreateCommentForm import CreateCommentForm
...
def post_list(request, category_name=model_helpers.post_category_all.slug()):
    ...
    return render(request, 'view/post_list.html', context)
...
def post_detail(request, post_id, message=''):
    ...
    return render(request, 'view/post_detail.html', context)